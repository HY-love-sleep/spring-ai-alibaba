...
public class GraphController {
    ...
    @Autowired
    public GraphController(@Qualifier("humanGraph") StateGraph stateGraph) throws GraphStateException {
    ...
    public Flux<ServerSentEvent<String>> expand(@RequestParam(value = "query", defaultValue = "你好，很高兴认识你，能简单介绍一下自己吗？", required = false) String query,
                                                ...
                                                @RequestParam(value = "thread_id", defaultValue = "yhong", required = false) String threadId) throws GraphRunnerException {
